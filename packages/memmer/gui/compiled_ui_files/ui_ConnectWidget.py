...
class Ui_ConnectWidget(object):
    def setupUi(self, ConnectWidget):
        ...
        self.formLayout_7.setWidget(0, QFormLayout.ItemRole.LabelRole, self.db_backend_label)
        ...
        self.formLayout_7.setWidget(0, QFormLayout.ItemRole.FieldRole, self.db_backend_combo)

        self.db_user_label = QLabel(self.database_group)
        self.db_user_label.setObjectName(u"db_user_label")

        self.formLayout_7.setWidget(1, QFormLayout.ItemRole.LabelRole, self.db_user_label)

        self.db_user_input = QLineEdit(self.database_group)
        self.db_user_input.setObjectName(u"db_user_input")

        self.formLayout_7.setWidget(1, QFormLayout.ItemRole.FieldRole, self.db_user_input)

        self.db_password_label = QLabel(self.database_group)
        self.db_password_label.setObjectName(u"db_password_label")

        self.formLayout_7.setWidget(2, QFormLayout.ItemRole.LabelRole, self.db_password_label)
        ...
        self.formLayout_7.setWidget(2, QFormLayout.ItemRole.FieldRole, self.db_password_edit)

        self.db_host_label = QLabel(self.database_group)
        self.db_host_label.setObjectName(u"db_host_label")

        self.formLayout_7.setWidget(3, QFormLayout.ItemRole.LabelRole, self.db_host_label)

        self.db_host_input = QLineEdit(self.database_group)
        self.db_host_input.setObjectName(u"db_host_input")

        self.formLayout_7.setWidget(3, QFormLayout.ItemRole.FieldRole, self.db_host_input)

        self.db_port_label = QLabel(self.database_group)
        self.db_port_label.setObjectName(u"db_port_label")

        self.formLayout_7.setWidget(4, QFormLayout.ItemRole.LabelRole, self.db_port_label)
        ...
        self.formLayout_7.setWidget(4, QFormLayout.ItemRole.FieldRole, self.db_port_spinner)

        self.db_name_label = QLabel(self.database_group)
        self.db_name_label.setObjectName(u"db_name_label")

        self.formLayout_7.setWidget(5, QFormLayout.ItemRole.LabelRole, self.db_name_label)

        self.db_name_input = QLineEdit(self.database_group)
        self.db_name_input.setObjectName(u"db_name_input")

        self.formLayout_7.setWidget(5, QFormLayout.ItemRole.FieldRole, self.db_name_input)
        ...
        self.formLayout_8.setWidget(1, QFormLayout.ItemRole.LabelRole, self.ssh_user_label)

        self.ssh_user_input = QLineEdit(self.ssh_group)
        self.ssh_user_input.setObjectName(u"ssh_user_input")

        self.formLayout_8.setWidget(1, QFormLayout.ItemRole.FieldRole, self.ssh_user_input)

        self.ssh_port_label = QLabel(self.ssh_group)
        self.ssh_port_label.setObjectName(u"ssh_port_label")

        self.formLayout_8.setWidget(2, QFormLayout.ItemRole.LabelRole, self.ssh_port_label)
        ...
        self.formLayout_8.setWidget(2, QFormLayout.ItemRole.FieldRole, self.ssh_port_spinner)
        ...
        self.formLayout_8.setWidget(0, QFormLayout.ItemRole.LabelRole, self.ssh_host_label)

        self.ssh_host_input = QLineEdit(self.ssh_group)
        ...
        self.connect_button = QPushButton(ConnectWidget)
        ...
        self.horizontalLayout_19.addWidget(self.connect_button)
    ...
    def retranslateUi(self, ConnectWidget):
        ...
        self.db_name_input.setPlaceholderText(QCoreApplication.translate("ConnectWidget", u"awesome_database", None))
